...
const Layoutable = (computeStyleFromProps = props => {}, options) => Composed => {
  const Wrapped = class extends _react.default.Component {
    ...
    render() {
      ...
      const layoutRect = /*#__PURE__*/_react.default.createElement(_layoutRect.default, (0, _extends2.default)({
      ...
      }, this.options.renderLayoutRect ? layoutRect : null, /*#__PURE__*/_react.default.createElement(Composed, (0, _extends2.default)({}, layoutProp, this.props)));
    }
